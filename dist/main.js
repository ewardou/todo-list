...
function createTodoElement(todo){
    ...
    if (todo.dueDate){
        let format=capitalize((0,date_fns_formatDistanceToNow__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(todo.dueDate),{addSuffix:true}));
